...
bool C_2D_COLLOSION::CheckHitDotToDot(VECTOR dotPos1, VECTOR dotPos2)
{
...
bool C_2D_COLLOSION::CheckHitDotToSquare2D(VECTOR dotPos, VECTOR squarePos, int width, int height)
{
...
bool C_2D_COLLOSION::CheckHitDotToSquare2D(VECTOR dotPos, VECTOR vertexPos1, VECTOR vertexPos2, VECTOR vertexPos3,
...
bool C_2D_COLLOSION::CheckHitSquareToSquare2D(VECTOR S_squarePos, VECTOR E_squarePos, int S_width, int S_height, int E_width, int E_height)
{
...
bool C_2D_COLLOSION::CheckHitCircleToCircle2D(VECTOR S_circlePos, VECTOR E_cleclePos, int S_redius, int E_redius)
{
	//半径Aの2乗+半径Bの2乗
