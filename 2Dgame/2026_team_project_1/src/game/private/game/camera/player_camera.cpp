...
{
	//キーコンフィグを利用した入力に変更する
	if (C_INPUT_CONFIG::IsButtanInput(C_INPUT_CONFIG::COM_ROT_L))	//左回転処理
	{
		m_rot.y += 0.05f;
	}
	else if (C_INPUT_CONFIG::IsButtanInput(C_INPUT_CONFIG::COM_ROT_R))	//右回転処理
	{
		m_rot.y -= 0.05f;
	}

	//キーコンフィグを利用した入力に変更する
	if (C_INPUT_CONFIG::IsButtanInput(C_INPUT_CONFIG::COM_ROT_U))	//左回転処理
	{
		m_rot.x += 0.05f;
	}
	else if (C_INPUT_CONFIG::IsButtanInput(C_INPUT_CONFIG::COM_ROT_D))	//右回転処理
	{
		m_rot.x -= 0.05f;
	}
