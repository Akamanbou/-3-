...
void C_SCENE_MANAGER::Init()
{
	...
	c_2DHndlManager = C_2D_HNDL_MANAGER::GetInstance();
	c_3DHndlManager = C_3D_HNDL_MANAGER::GetInstance();
...
void C_SCENE_MANAGER::Exit()
{
	...
	c_2DHndlManager->DeleteAll2DData();
	c_2DHndlManager->DeleteInstance();
	c_3DHndlManager->DeleteAll3DModel();
	c_3DHndlManager->DeleteInstance();
